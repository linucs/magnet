...
gem 'remotipart', github: 'foxsoft/remotipart' #, '~> 1.2.1'
gem 'rails_autolink', '~> 1.1.6'
gem 'bootstrap_flash_messages', '~> 1.0.0'
gem 'kaminari', '~> 0.16.1'
gem 'crummy', '~> 1.8.0'
gem 'recursive-open-struct', '~> 1.0.1'
gem 'clean_pagination', '~> 1.0.0'
gem 'video_info', '~> 2.6.1'
gem 'gon', '~> 6.1.0'
...
gem 'sidekiq-logging-json', '~> 0.0.16'
gem 'sidekiq-cron', '~> 0.4.3'
gem 'redis-rails', '~> 5.0.1'
gem 'redis', github: 'develon/redis-rb'
gem 'mechanize', '~> 2.7.3'
...
gem 'shortener', '~> 0.5.5'
gem 'ancestry', '~> 2.1.0'
gem 'date_picker', github: 'develon/date_picker'
gem 'bootsy', github: 'develon/bootsy'

...
Rails.application.config.assets.precompile += %w( deck/themes/* timeline/themes/* wall/themes/* reveal.js/css/*.css reveal.js/lib/font/*.css fancybox/source/*.png fancybox/source/*.gif )
